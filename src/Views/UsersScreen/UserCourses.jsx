            ...
            >
              ...
              <TabPanels>
                <TabPanel padding={"20px"}>
                  <Text
                    fontSize={{ base: "25px", md: "20px", lg: "25px" }}
                  ...
                  <Box display={"flex"} flexDirection="column">
                    ...
                    >
                      ...
                      <Box width={"100%"} padding={"10px"}>
                        <Text fontWeight={"600"} color="black" fontSize="18px">
                  ...
                  <Box color={"black"} marginBottom={"30px"}>
                    ...
                    >
                      ...
                      <Box display={{ base: "none", md: "none", lg: "block" }}>
                        ...
                        <Text mt={"10px"} cursor="pointer" color={"blue"}>
                          View Courses
                        </Text>
                      </Box>
                      <Box display={{ base: "none", md: "none", lg: "block" }}>
                    ...
                    <TabPanels>
                      <TabPanel>
                        <Box>
                          ...
                          <Box>
                            <Box margin={"20px 0"}>
                              <Text fontSize={"normal"} color={"gray.300"}>
                                Email:
                              </Text>
